...
export function TopBar({ onNavigate }) {
  ...
  el.className = 'top-bar glass-panel';
  ...
  setTimeout(() => {
    // Profile navigation
    el.querySelector('.hud-profile').addEventListener('click', () => {
      onNavigate('profile');
    });

    // Notification dropdown
    const notifContainer = el.querySelector('.notification-container');
    const notifBtn = el.querySelector('.notification-btn');
